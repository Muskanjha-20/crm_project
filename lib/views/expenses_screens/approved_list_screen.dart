...
import 'package:list_project/views/expenses_screens/expenses_approved_list_details.dart';
...
class ApprovedListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> learningExpenses = [
      {"amount": "₹55", "date": "14 September 2024", "type": "E-Learning"},
      {"amount": "₹55", "date": "18 September 2024", "type": "E-Learning"},
    ];
              ...
              return CustomListItemExpenseWidget(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const ExpensesApprovedListDetails(),
                    ),
                  );
                },
              );
